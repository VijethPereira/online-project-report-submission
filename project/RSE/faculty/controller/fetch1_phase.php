...
if (isset($_POST['year'])) {
    ...
    $count = $faculty->getPhaseCount($year);
    $res = $faculty->getPhaseValues($year);
    $id = $res['id'];
    if (!$count) {
        $output .= '
        ...
        $stmt = $faculty->get_phaseValues($id);
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        ...
                                        <a href="../assets/phase/'.$row['attachment'].'" target="_blank" class="btn btn-primary btn-pill"> PDF</a>
                                            <a href="view_uploads.php?id='.$row['id'].'" target="_blank" class="btn btn-warning btn-pill"> Evaluate</a>
