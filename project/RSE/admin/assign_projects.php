                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <a href="add_project_student.php?id=<?php echo $row['id'] ?>" class="btn btn-success btn-pill">Assign Project</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $('#year').change(function(){
            ...
            if (year == "0") {
                ...
                $.ajax({
                    url:"controller/fetch_assign_project.php",
                    method: "post",
                    data: {year:year},
                    dataType:"text",
