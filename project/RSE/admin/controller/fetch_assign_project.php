...
if (isset($_POST['year'])) {
    ...
    $count = $admin->get_batch_groupCount($year);
    ...
    if (!$count) {
        ...
        $stmt = $admin->get_batch_groupyear($year);
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <a href="add_project_student.php?id='. $row['id'] .'" class="btn btn-success btn-pill">Assign Project</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
